...
Feature: Fields for Publication content type
  ...
  Scenario: The content type has the expected fields (and labels where we can use them).
    ...
    And I should see an "textarea#edit-field-publication-intro-text-0-value" element
    ...
    And the "#edit-field-featured-image" element should contain "Publication Image"
